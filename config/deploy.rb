...
set :repo_url, "git@github.com:eschlange/#{ fetch(:application) }.git"
set :rvm_type, :system
...
<VirtualHost *:80>
  ...
  Redirect permanent / https://prim-resources-staging.cbits.northwestern.edu/
</VirtualHost>
...
<VirtualHost *:80>
  ...
  Redirect permanent / https://prim-resources.cbits.northwestern.edu/
</VirtualHost>
